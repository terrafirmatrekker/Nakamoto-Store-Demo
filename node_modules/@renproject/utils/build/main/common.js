...
const fromHex = (hex) => {
    ...
    return Buffer.isBuffer(hex) ? hex : Buffer.from(exports.strip0x(hex), "hex");
};
...
const toURLBase64 = (input) => {
    ...
    return (Buffer.isBuffer(input) ? input : exports.fromHex(input))
        .toString("base64")
        .replace(/\+/g, "-")
        .replace(/\//g, "_")
        .replace(/\=+$/, "");
...
const rawEncode = (types, parameters) => exports.fromHex(new web3_eth_abi_1.AbiCoder().encodeParameters(types, parameters));
