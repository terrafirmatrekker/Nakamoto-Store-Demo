...
export declare class RenVMProvider implements AbstractRenVMProvider<RenVMParams, RenVMResponses> {
    ...
    readonly queryMintOrBurn: <T extends LockAndMintTransaction | BurnAndReleaseTransaction>(_selector: string, utxoTxHash: Buffer) => Promise<T>;
