    ...
    constructor(renVM, params, config = {}) {
        ...
        this.processDeposit = async (deposit) => {
            ...
            // confidenceRatio > existingConfidenceRatio)
                ...
                depositObject = new LockAndMintDeposit(deposit, this.params, this.renVM, Object.assign(Object.assign({}, this._state), { renNetwork: this._state.renNetwork, pHash: this._state.pHash, gHash: this._state.gHash, gPubKey: this._state.gPubKey, targetConfirmations: utils_1.isDefined(this._state.targetConfirmations)
        ...
        this.generateGatewayAddress = async () => {
            ...
            const gHash = utils_1.generateGHash(contractParams || [], sendTo, tokenGatewayContract, utils_1.fromHex(nonce), this.renVM.version(this._state.selector) >= 2, this._state.logger);
...
class LockAndMintDeposit {
    ...
    constructor(depositDetails, params, renVM, state) {
        ...
        const filteredContractParams = contractParams
            ...
            : contractParams;
        const encodedParameters = new web3_eth_abi_1.AbiCoder().encodeParameters((filteredContractParams || []).map((i) => i.type), (filteredContractParams || []).map((i) => i.value));
        ...
        const nHash = utils_1.generateNHash(utils_1.fromHex(nonce), transactionDetails.txid, transactionDetails.txindex, renVM.version(state.selector) >= 2);
        ...
        this._state.txHash = (renVM.version(this._state.selector) >= 2
            ? utils_1.toURLBase64
            : utils_1.toBase64)(this.renVM.mintTxHash(Object.assign(Object.assign({}, this._state), { outputHashFormat })));
        if (providedTxHash &&
