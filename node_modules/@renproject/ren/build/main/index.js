    ...
    constructor(providerOrNetwork, config) {
        ...
        this.getFees = async ({ asset, from, to, }) => {
            ...
            if (await from.assetIsNative(asset)) {
                ...
                fees = Object.assign(Object.assign({}, lockFees), mintFees);
            }
         ...
         */
        this.lockAndMint = async (params) => new lockAndMint_1.LockAndMint(this.renVM, params, this._config)._initialize();
        /**
         * `burnAndRelease` submits a burn log to RenVM.
         * Returns a [[BurnAndRelease]] object.
         */
        this.burnAndRelease = async (params) => new burnAndRelease_1.BurnAndRelease(this.renVM, params, this._config)._initialize();
        this._config = config || {};
        this._logger =
