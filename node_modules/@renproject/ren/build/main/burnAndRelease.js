    ...
    constructor(renVM, params, config = {}) {
        ...
        this.txHash = () => {
            ...
            if (this.renVM.version(this._state.selector) >= 2 &&
                ...
                const gHash = utils_1.generateGHash([], utils_1.Ox(this.params.to.addressStringToBytes(to)), utils_1.Ox(sHash), nonceBuffer, this.renVM.version(this._state.selector) >= 2, this._state.logger);
