...
export default class RenJS {
     ...
     * ```
     */
    static defaultDepositHandler: ((deposit: import("./lockAndMint").LockAndMintDeposit<any, DepositCommon<any>, any, any, any>) => Promise<void>) & {
    ...
    readonly lockAndMint: <Transaction = any, Deposit extends DepositCommon<Transaction> = DepositCommon<Transaction>, Address extends string | {
        address: string;
    } = any>(params: LockAndMintParams<Transaction, Deposit, Address, any, any>) => Promise<LockAndMint<Transaction, Deposit, Address, any, any>>;
    /**
    ...
    readonly burnAndRelease: <Transaction = any, Deposit extends DepositCommon<Transaction> = DepositCommon<Transaction>, Address extends string | {
        address: string;
    } = any>(params: BurnAndReleaseParams<Transaction, Deposit, Address, any, any>) => Promise<BurnAndRelease<Transaction, Deposit, Address, any, any>>;
}
