...
export declare class LockAndMintDeposit<LockTransaction = any, LockDeposit extends DepositCommon<LockTransaction> = DepositCommon<LockTransaction>, LockAddress extends string | {
    ...
    /** @hidden */
    constructor(depositDetails: LockDeposit, params: LockAndMintParams<LockTransaction, LockDeposit, LockAddress, MintTransaction, MintAddress>, renVM: AbstractRenVMProvider, state: MintState & MintStatePartial);
    /** @hidden */
